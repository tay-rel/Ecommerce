                ...
                <div class="flex  justify-between p-5">
                    ...
                    <div class="relative" x-data="{ open: false }">
                        <button @click="open = !open"
                                class="flex items-center justify-between bg-indigo-500  px-4 py-2 text-sm font-medium text-white  rounded-md  focus:outline-none   focus:ring-indigo-500">
                        ...
                        <div x-show="open" @click.away="open = false"
                            ...
                            @foreach($columns as $column)
                                <label class="block px-4 py-2 text-sm font-medium text-gray-700">
                                    <input type="checkbox" wire:model="selectedColumn" value="{{ $column }}"
